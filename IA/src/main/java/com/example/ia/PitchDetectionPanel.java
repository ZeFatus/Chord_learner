...
//This class undertakes the audio detection process
public class PitchDetectionPanel implements PitchDetectionHandler {
    ...
    //This is the specific method called to initialize audio detection process
...
String correct = String.valueOf(played);
            ...
            //adds boolean value indicating whether a note was played correctly to the array to be displayed to the user
